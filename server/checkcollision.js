...
function getRotatedSquareCoordinates(square){
    ...
    let centerX = square.pos.x + (square.size.x / 2);
    let centerY = square.pos.y + (square.size.y / 2);
    //Work out the new locations
    let topLeft = workOutNewPoints(centerX, centerY, square.pos.x, square.pos.y, square.angle);
    let topRight = workOutNewPoints(centerX, centerY, square.pos.x + square.size.x, square.pos.y, square.angle);
    let bottomLeft = workOutNewPoints(centerX, centerY, square.pos.x, square.pos.y + square.size.y, square.angle);
    let bottomRight = workOutNewPoints(centerX, centerY, square.pos.x + square.size.x, square.pos.y + square.size.y, square.angle);
    return{
        tl: topLeft,
        tr: topRight,
        bl: bottomLeft,
...
function checkCollision(obj1, obj2){
    ...
    let tRR = getRotatedSquareCoordinates(obj1);
    let oRR = getRotatedSquareCoordinates(obj2);
